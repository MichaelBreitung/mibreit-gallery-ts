...
export declare const BACKGROUND_COLOR_VARIABLE = "--background-color";
export declare const FOREGROUND_COLOR_VARIABLE = "--foreground-color";
export declare const PRELOADER_RIGHT_SIZE = 1;
export declare const PRELOADER_LEFT_SIZE = 0;
export declare const SLIDESHOW_INTERVAL = 5000;
export declare const NUMBER_OF_VISIBLE_THUMBS = 7;
export declare const RESIZE_DEBOUNCE_TIMER = 500;
